...
import com.ext.redis.config.FlinkJedisClusterConfig;
import com.ext.redis.config.FlinkJedisConfigBase;
import com.ext.redis.config.FlinkJedisPoolConfig;
import com.ext.redis.config.FlinkJedisSentinelConfig;
import com.ext.redis.container.RedisClusterContainer;
import com.ext.redis.container.RedisCommandsContainer;
import com.ext.redis.container.RedisContainer;
 ...
 */
public class MobsCommandsContainerBuilder {
	...
	public static RedisCommandsContainer build(FlinkJedisConfigBase flinkJedisConfigBase){
		if(flinkJedisConfigBase instanceof FlinkJedisPoolConfig){
			...
			return MobsCommandsContainerBuilder.build(flinkJedisPoolConfig);
			...
			return MobsCommandsContainerBuilder.build(flinkJedisClusterConfig);
			...
			return MobsCommandsContainerBuilder.build(flinkJedisSentinelConfig);
		} else {
